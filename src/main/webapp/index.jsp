...
<body id="page-top">
    ...
    String usn=(String)session.getAttribute("myUsn");
    List<CourseModule> lstMonHoc=(List<CourseModule>)session.getAttribute("lstCourseModule");
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto my-2 my-lg-0">
					...
					<%
                        if(usn!=null){
                        %>
					<li class="nav-item"><a class="nav-link" href="#listUsers"><%=usn%></a></li>
					<%}else {%>
		...
		<div class="container px-4 px-lg-5 h-100">
			<div
				...
				<div class="col-lg-8 align-self-end">
					...
					<%}else{ %>
					<h1 class="text-white font-weight-bold">Chào mừng bạn đến với
						hệ thống của chúng tôi!</h1>
					<%} %>
					<hr class="divider" />
				</div>
				<div class="col-lg-8 align-self-baseline">
					...
					<table class="table text-white-75 mb-5 ">
						<thead>
							<tr>
								<th scope="col">TT</th>
						...
						<tbody>
							<tr>
								...
								<td><%=lstMonHoc.get(i).getMaHP() %></td>
								<td><%=lstMonHoc.get(i).getTenHP() %></td>
								<td><%=lstMonHoc.get(i).getSoTichChi() %></td>
								<td><%=lstMonHoc.get(i).getMaHPTienQuyet() %></td>
